...
const Header = () => {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/60 backdrop-blur-md border-b border-gray-200/50">
      <div className="flex justify-between items-center py-4 px-8 max-w-7xl mx-auto w-full">
        ...
        <div className="flex items-center gap-2 cursor-pointer">
          ...
          <span className="font-bold text-2xl text-blue-600 tracking-tight">Zenvyra</span>
        </div>

        {/* Navigation */}
        <nav className="hidden md:flex bg-white/80 backdrop-blur-sm px-8 py-3 rounded-full shadow-sm border border-gray-100 items-center gap-8 text-sm font-medium text-gray-600 transition-all">
